...
export function GenericInterruptView({
  ...
  return (
    <div className="overflow-hidden rounded-lg border border-border/80 bg-card/40 bg-gradient-to-b from-fuchsia-300/10 to-transparent ring-1 ring-fuchsia-300/10">
