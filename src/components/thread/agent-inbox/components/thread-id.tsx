...
export function ThreadIdTooltip({ threadId }: { threadId: string }) {
  ...
  return (
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger>
          <p className="rounded-md bg-secondary px-1 py-[2px] font-mono text-[10px] leading-[12px] tracking-tighter">
...
export function ThreadIdCopyable({
  ...
  return (
    <TooltipIconButton
      ...
      className="flex w-fit flex-grow-0 cursor-pointer items-center gap-1 rounded-md border-[1px] border-border p-1 hover:bg-secondary/80"
    >
